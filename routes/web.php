...
$router->post('/help/contact', [PublicController::class, 'submitHelp']);
...
$router->get('/auth/check-username', [AuthController::class, 'checkUsername']);
...
$router->post('/admin/finance/review-topup', [AdminController::class, 'reviewTopUp']);
$router->post('/admin/operations/content/save', [AdminController::class, 'saveManagedContent']);
$router->post('/admin/operations/content/delete', [AdminController::class, 'deleteManagedContent']);
$router->post('/admin/operations/plan/save', [AdminController::class, 'saveManagedPlan']);
$router->post('/admin/operations/plan/delete', [AdminController::class, 'deleteManagedPlan']);
$router->post('/admin/operations/live/save', [AdminController::class, 'saveManagedLive']);
$router->post('/admin/operations/live/delete', [AdminController::class, 'deleteManagedLive']);
