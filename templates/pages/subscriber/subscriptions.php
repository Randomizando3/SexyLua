...
<aside class="fixed left-0 top-16 hidden h-[calc(100vh-64px)] w-64 flex-col bg-[#f5f3f5] p-6 shadow-[0px_20px_40px_rgba(27,28,29,0.06)] lg:flex">
    <nav class="space-y-2">
        <a class="flex items-center gap-4 rounded-full px-4 py-3 text-slate-500 transition-colors hover:bg-white/60" href="/subscriber">
            <span class="material-symbols-outlined">home</span>
            <span>Inicio</span>
        </a>
        <a class="flex items-center gap-4 rounded-full bg-white px-4 py-3 font-bold text-primary" href="/subscriber/subscriptions">
    ...
    <a class="signature-glow mt-auto flex items-center justify-center rounded-full px-6 py-4 text-sm font-bold text-white shadow-lg" href="/explore">Explorar criadores</a>
</aside>
