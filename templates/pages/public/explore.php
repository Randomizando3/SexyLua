...
<main class="mx-auto max-w-7xl px-6 pb-20 pt-28 md:px-8">
    ...
    <section class="mb-14">
        <div class="mb-6 flex items-end justify-between gap-6">
            <div>
                <h2 class="headline text-3xl font-extrabold">Lives em destaque</h2>
                <p class="mt-2 text-sm text-slate-500"><?= e($includeScheduled ? 'Salas ao vivo e transmissoes que ja foram agendadas pelos criadores.' : 'Apenas as salas que ja estao ao vivo agora.') ?></p>
            </div>
        </div>
