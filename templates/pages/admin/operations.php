                                ...
                                <form action="/admin/operations/live/save" class="grid grid-cols-1 gap-6 2xl:grid-cols-[1.15fr_0.85fr]" method="post">
                                    ...
                                    <div class="space-y-4">
                                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                            ...
                                            <input class="w-full rounded-2xl border-none bg-white px-5 py-4 shadow-sm focus:ring-2 focus:ring-primary/20" min="0" name="darkroom_price_luacoins" placeholder="Valor para tornar a sala DarkRoom" step="1" type="number" value="<?= e((string) ($live['darkroom_price_tokens'] ?? 0)) ?>">
                                            <input class="w-full rounded-2xl border-none bg-white px-5 py-4 shadow-sm focus:ring-2 focus:ring-primary/20" min="0" name="darkroom_duration_minutes" placeholder="Duração da Sala DarkRoom" step="1" type="number" value="<?= e((string) ($live['darkroom_duration_minutes'] ?? 0)) ?>">
                                        </div>
                                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                            <label class="flex items-center gap-3 rounded-2xl bg-white px-5 py-4 text-sm font-bold text-on-surface">
