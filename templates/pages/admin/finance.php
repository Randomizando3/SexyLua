...
<main class="min-h-screen px-6 pb-10 pt-24 lg:ml-64 lg:px-10">
    <section class="mb-8 flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
        ...
        <div class="grid grid-cols-2 gap-4 md:grid-cols-3 xl:grid-cols-5">
            ...
            <article class="rounded-3xl bg-surface-container-lowest p-5 text-center shadow-sm"><p class="text-xs font-bold uppercase tracking-[0.25em] text-slate-400">Repasse</p><p class="mt-3 text-3xl font-extrabold text-emerald-600"><?= e(token_amount((int) ($summary['creator_income'] ?? 0))) ?></p></article>
            <article class="rounded-3xl bg-surface-container-lowest p-5 text-center shadow-sm"><p class="text-xs font-bold uppercase tracking-[0.25em] text-slate-400">Resultado</p><p class="mt-3 text-3xl font-extrabold text-primary"><?= e(token_amount((int) ($summary['platform_result'] ?? 0))) ?></p></article>
            <article class="rounded-3xl bg-surface-container-lowest p-5 text-center shadow-sm"><p class="text-xs font-bold uppercase tracking-[0.25em] text-slate-400">Recargas</p><p class="mt-3 text-3xl font-extrabold text-primary"><?= e((string) ($summary['top_ups'] ?? 0)) ?></p></article>
            <article class="rounded-3xl bg-surface-container-lowest p-5 text-center shadow-sm"><p class="text-xs font-bold uppercase tracking-[0.25em] text-slate-400">Saques pendentes</p><p class="mt-3 text-3xl font-extrabold text-amber-600"><?= e((string) ($summary['pending_payout_count'] ?? 0)) ?></p></article>
        </div>
    </section>
