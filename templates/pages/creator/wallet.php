...
<head>
    ...
    <style>
        body{font-family:Manrope,sans-serif;background:#fbf9fb;color:#1b1c1d}.headline{font-family:'Plus Jakarta Sans',sans-serif}.signature-glow{background:linear-gradient(135deg,#D81B60 0%,#ab1155 100%)}.material-symbols-outlined{font-variation-settings:"FILL" 0,"wght" 400,"GRAD" 0,"opsz" 24}
    </style>
</head>
<body>
<?php
