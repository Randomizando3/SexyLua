        ...
        <section class="rounded-3xl bg-white p-8 shadow-[0px_20px_40px_rgba(27,28,29,0.06)]" id="members-dashboard">
            ...
            <form action="/creator/memberships" class="mt-6 grid grid-cols-1 gap-4 rounded-3xl bg-[#f5f3f5] p-5 md:grid-cols-2 xl:grid-cols-[minmax(0,1fr)_minmax(0,0.6fr)_auto]" method="get">
                ...
                <div class="flex w-full items-end gap-3 md:w-auto">
                    <button class="flex-1 rounded-full bg-slate-900 px-6 py-4 text-sm font-bold text-white md:min-w-[132px]" data-prototype-skip="1" type="submit">Filtrar</button>
                    <a class="flex-1 rounded-full bg-white px-6 py-4 text-center text-sm font-bold text-[#5a4044] md:min-w-[132px]" href="/creator/memberships">Reset</a>
                </div>
            </form>
...
<div class="fixed inset-0 z-[90] hidden items-start justify-center overflow-y-auto bg-slate-950/40 px-4 py-8 sm:py-12 backdrop-blur-sm" data-plan-modal>
    <div class="my-auto w-full max-w-3xl rounded-3xl bg-white p-8 shadow-[0px_30px_80px_rgba(27,28,29,0.22)] max-h-[calc(100vh-4rem)] overflow-y-auto sm:max-h-[calc(100vh-6rem)]">
        <div class="relative min-h-[3rem] pr-14">
            <div>
            ...
            <button class="absolute right-0 top-0 z-10 inline-flex h-11 w-11 items-center justify-center rounded-full bg-[#f5f3f5] text-slate-500" data-plan-close type="button">
