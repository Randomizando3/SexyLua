...
$creatorMenuItems = [
    ...
    ['key' => 'public_profile', 'href' => creator_public_url($creatorShellCreator), 'icon' => 'public', 'label' => 'Minha Pagina'],
...
?>
<aside class="fixed left-0 top-0 z-40 hidden h-full w-64 flex-col overflow-y-auto rounded-r-[3rem] bg-zinc-50 px-4 pb-6 pt-20 font-['Plus_Jakarta_Sans'] font-medium shadow-xl lg:flex">
